...
impl<T, N: ArrayLength> IntExprNode<T, N, true>
where
    ...
    N: ArrayLength,
{
    ...
    fn mod_mul(self, rhs: Self) -> Self::Output {
        ...
        IntExprNode {
            creator: self.creator,
            indexes: GenericArray::try_from_iter(res.drain(..)).unwrap(),
        }
    }
}
    ...
    N: ArrayLength,
{
    ...
    fn cond_mul(self, rhs: Self) -> (Self::Output, Self::OutputCond) {
        ...
        let reshi = IntExprNode::<T, N, false> {
            ...
            indexes: GenericArray::<_, N>::try_from_slice(&res[N::USIZE..])
                .unwrap()
                .clone(),
        };
        (
            IntExprNode {
                creator: self.creator.clone(),
                indexes: GenericArray::<_, N>::try_from_slice(&res[0..N::USIZE])
                    .unwrap()
                    .clone(),
            },
...
mod tests {
    ...
    fn fullmull_signed_u10(
        ...
        let temp = IntExprNode::<isize, U20, true> {
            ...
            indexes: GenericArray::try_from_slice(&gen_dadda_mult(exp_ec.clone(), &mut matrix))
                .unwrap()
                .clone(),
        };
